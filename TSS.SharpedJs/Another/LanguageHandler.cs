namespace TSS.SharpedJs
{
    ...
    class LanguageHandler
    {
        ...
        public static LanguageHandler Instance
        {
            ...
            {
                if (lh == null)
                    SetLanguage(LanguageHandlerCulture.ru);
                return lh;
            }
        }
        ...
        LanguageHandler(LanguageHandlerCulture language)
        {
            ...
            switch (language)
            {
                case LanguageHandlerCulture.en:
                    if (CookieManager.Instance.IsCookiesEnabled)
                        CookieManager.Instance.SetValue("lang", "en");
                    InitLanguage_En();
                    break;
                case LanguageHandlerCulture.ru:
                    if (CookieManager.Instance.IsCookiesEnabled)
                        CookieManager.Instance.SetValue("lang", "ru");
                    InitLanguage_Ru();
                    break;
            }
        }
        ...
        public string TitleOfUniverseConstsRedactor = "Universe consts redactor";
        ...
        public string IncorrectValueMsg = "Value at field \"{0}\" is incorrect. ";
        ...
        public string UniverseSizeWarning="Universe side must be at range from 2 to 200.";
        ...
        public string LabelOpenManual = "Open manual";
        //Default strings
        ...
        void InitLanguage_En()
        {
            ...
            CellsCountWarningMessage = "Can`t create cells. Count of cells is a natural number < 300.";
            ...
            ButtonOk = "Ok";
            ButtonCancel = "Cancel";
            UniverseSizeWarning = "Universe side must be number at range from 2 to 200.";
        ...
        void InitLanguage_Ru()
        {
            ...
            TitleOfUniverseConstsRedactor = "Редактор констант вселенной";
            ...
            IncorrectValueMsg = "Значение поля \"{0}\" некорректно. ";
            ...
            CellsCountWarningMessage = "Создание клеток невозможно. Количество клеток - натуральное число  < 300.";
            ...
            ButtonOk = "Ок";
            ButtonCancel = "Отмена";
            UniverseSizeWarning = "Сторона вселенной должна быть числом в промежутке от 2 до 200.";
            ...
            LabelOpenManual = "Открыть мануал";
        }
    }
}
